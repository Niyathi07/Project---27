...
function setup() {
	...
	bob2 = new Bob (220,300,15);
  bob3 = new Bob (240,300,15);
	bob4 = new Bob (260,300,15);
	bob5 = new Bob (280,300,15);

	ground = new Roof(100,398,2000,10);

  roof = new Roof(500,50,50,10);
...
function keyPressed(){
  ...
  if (keyCode === UP_ARROW){
    ...
    Matter.Body.applyForce(bob3.body, bob3.body.position, {x:50,y:-140})
  }
